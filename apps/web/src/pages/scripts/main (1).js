...
function renderRecentTools() {
  ...
  try {
    ...
    container.innerHTML = '<div style="margin-bottom:8px"><h3 class="tp-subsection">Recently used</h3></div><div class="tp-grid">' +
      tools.map(function(t) {
        return '<a href="' + t.url + '" class="tp-card">' +
          '<div class="tp-card-icon tp-icon-orange">' + t.icon + '</div>' +
          '<div class="tp-card-body"><div class="tp-card-name">' + t.name + '</div>' +
          '<div class="tp-card-desc">' + t.cat + '</div></div></a>';
      }).join('') + '</div>';
